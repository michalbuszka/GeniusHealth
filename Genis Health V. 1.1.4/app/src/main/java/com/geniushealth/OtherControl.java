...
public class OtherControl extends AppCompatActivity {
    ...
    {
        String[] programs = getResources().getStringArray(R.array.otherProgramResource);
        final String programName = programs[programNum[index]];
        runOnUiThread(() -> text.setText(programName));
    }
    @RequiresApi(api = Build.VERSION_CODES.M)
    protected void setupInputs ()
    {
        amplitudeInfo[0] = findViewById(R.id.otherAmplitude1);
        amplitudeInfo[1] = findViewById(R.id.otherAmplitude2);
        amplitudeInfo[2] = findViewById(R.id.otherAmplitude3);
        amplitudeInfo[3] = findViewById(R.id.otherAmplitude4);
        amplitudeInfo[4] = findViewById(R.id.otherAmplitude5);
        amplitudeInfo[5] = findViewById(R.id.otherAmplitude6);
        timeInfo[0] = findViewById(R.id.otherTimeLeft1);
        timeInfo[1] = findViewById(R.id.otherTimeLeft2);
        timeInfo[2] = findViewById(R.id.otherTimeLeft3);
        timeInfo[3] = findViewById(R.id.otherTimeLeft4);
        timeInfo[4] = findViewById(R.id.otherTimeLeft5);
        timeInfo[5] = findViewById(R.id.otherTimeLeft6);
        frequencyInfo[0] = findViewById(R.id.otherFrequency1);
        frequencyInfo[1] = findViewById(R.id.otherFrequency2);
        frequencyInfo[2] = findViewById(R.id.otherFrequency3);
        frequencyInfo[3] = findViewById(R.id.otherFrequency4);
        frequencyInfo[4] = findViewById(R.id.otherFrequency5);
        frequencyInfo[5] = findViewById(R.id.otherFrequency6);
        amplitudeButtonPlus[0] = findViewById(R.id.otherAmplitudePlus1);
        amplitudeButtonPlus[1] = findViewById(R.id.otherAmplitudePlus2);
        amplitudeButtonPlus[2] = findViewById(R.id.otherAmplitudePlus3);
        amplitudeButtonPlus[3] = findViewById(R.id.otherAmplitudePlus4);
        amplitudeButtonPlus[4] = findViewById(R.id.otherAmplitudePlus5);
        amplitudeButtonPlus[5] = findViewById(R.id.otherAmplitudePlus6);
        amplitudeButtonMinus[0] = findViewById(R.id.otherAmplitudeMinus1);
        amplitudeButtonMinus[1] = findViewById(R.id.otherAmplitudeMinus2);
        amplitudeButtonMinus[2] = findViewById(R.id.otherAmplitudeMinus3);
        amplitudeButtonMinus[3] = findViewById(R.id.otherAmplitudeMinus4);
        amplitudeButtonMinus[4] = findViewById(R.id.otherAmplitudeMinus5);
        amplitudeButtonMinus[5] = findViewById(R.id.otherAmplitudeMinus6);
        pauseButton[0] = findViewById(R.id.otherPause1);
        pauseButton[1] = findViewById(R.id.otherPause2);
        pauseButton[2] = findViewById(R.id.otherPause3);
        pauseButton[3] = findViewById(R.id.otherPause4);
        pauseButton[4] = findViewById(R.id.otherPause5);
        pauseButton[5] = findViewById(R.id.otherPause6);
        showProgramNum[0] = findViewById(R.id.otherShowProgram1);
        showProgramNum[1] = findViewById(R.id.otherShowProgram2);
        showProgramNum[2] = findViewById(R.id.otherShowProgram3);
        showProgramNum[3] = findViewById(R.id.otherShowProgram4);
        showProgramNum[4] = findViewById(R.id.otherShowProgram5);
        showProgramNum[5] = findViewById(R.id.otherShowProgram6);
        Button startButton =  findViewById(R.id.startProgramOther);
        for (int i = 0; i < 6; i++)
        {
            if (isDeviceOnOff[i])
            {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_control);
        setupInputs();
        MainThread.start();
        findViewById(R.id.otherControlBackArrow).setOnClickListener(v -> {
            if (xionis.checkIfDevicesAreOff())
            {
                isNotClosed = false;
                Intent intent = new Intent();
                intent.setClass(OtherControl.this, OtherMode.class);
